<template>
  <div
    ...
    @click.stop="clickBody($event)"
    @mousedown.stop="bodyDown($event)"
    @touchstart.stop="bodyDown($event)"
...
export default {
  ...
  mounted() {
    ...
    console.log("this.domEvents:::::::::::::::::::1", this.domEvents)
  ...
  beforeDestroy() {
    console.log("this.domEvents:::::::::::::::::::2222", this.domEvents)
    this.domEvents && removeEvents(this.domEvents);
  },
  ...
  methods: {
    ...
    move(ev) {
      ...
      const delta = {
        x: Math.ceil((dimensionsBeforeMove.pointerX - pageX) / this.parentScaleX) ,
        y: Math.ceil((dimensionsBeforeMove.pointerY - pageY) / this.parentScaleY) ,
      };
      ...
      if (this.bodyDrag) {
        ...
        // console.log("offsetScale:::::::::::::", dimensionsBeforeMove, ev.pageX, pageY,  delta, this.parentScaleX, this.parentScaleY, delta, this.stickDrag, this.bodyDrag)
        this.bodyMove(delta);
      }
    },
