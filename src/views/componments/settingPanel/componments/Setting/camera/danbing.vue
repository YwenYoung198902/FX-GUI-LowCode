    ...
    >
      ...
      <el-form-item label="边框颜色：" label-width="125px">
        <div class="flex align-center" style="color: aliceblue;">
          <el-color-picker
            v-model="config.wholeStyle.borderColor"
            show-alpha
            size="mini"
      ...
      <el-form-item label="背景颜色：" label-width="125px">
        <div class="flex align-center" style="color: aliceblue;">
          <el-color-picker
            v-model="config.wholeStyle.wholeBackground"
            show-alpha
            size="mini"
            style="margin-right: 5px;"
          ></el-color-picker>
      ...
      <el-form-item label="头部高度：">
        <el-input
          v-model="config.wholeStyle.height"
          size="mini"
          placeholder="请输入..."
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="文字颜色：">
        <div class="flex align-center" style="color: aliceblue;">
          <el-color-picker
            v-model="config.wholeStyle.color"
            show-alpha
            size="mini"
            style="margin-right: 5px;"
          ></el-color-picker>
      ...
      <el-form-item label="字体大小：">
        <div class="flex align-center">
          <el-input
            v-model="config.wholeStyle.fontSize"
            size="mini"
      ...
      <el-form-item label="字体缩进值：">
        <div class="flex align-center">
          <el-input
            v-model="config.wholeStyle.textIndent"
            size="mini"
            style="margin: 0 8px 0 0px"
          ></el-input
          >px
      ...
      <el-form-item label="行间距：">
        <div class="flex align-center">
          <el-input
            v-model="config.wholeStyle.lineHeight"
            size="mini"
            style="margin: 0 8px 0 0px"
          ></el-input
          >px
        ...
        <el-collapse-item title="关闭按钮" name="closeImg">
          ...
          <el-form-item label="高度：">
            <el-input
              v-model="config.closeImg.height"
              size="mini"
              placeholder="请输入..."
            ></el-input>
          </el-form-item>
          <el-form-item label="上边距：">
            <el-input
              v-model="config.closeImg.marginTop"
              size="mini"
              placeholder="请输入..."
            ></el-input>
          </el-form-item>
          <el-form-item label="右边距：">
            <el-input
              v-model="config.closeImg.marginRight"
              size="mini"
              placeholder="请输入..."
            ></el-input>
          </el-form-item>
