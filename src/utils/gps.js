/**
 * Created by zhuzx on 2019/9/17/017.
 */
/**
 * 纠偏算法
 * @type {{
 ...
 *          gcj_decrypt_exact: gcj_decrypt_exact,
 *          bd_encrypt: bd_encrypt,
 *          bd_decrypt: bd_decrypt,
 *          mercator_encrypt: mercator_encrypt,
 *          mercator_decrypt: mercator_decrypt,
 *          distance: distance,
...
export const gps = {
  ...
  gcj_decrypt_str: function(gcjLat, gcjLon) {
    if (this.outOfChina(gcjLat, gcjLon)) {
  ...
  gcj_decrypt_circleSelect: function(gcjLat, gcjLon) {
    if (this.outOfChina(gcjLat, gcjLon)) {
      return gcjLat + ',' + gcjLon;
    }
    const d = this.delta(gcjLat, gcjLon);
