 ...
 * @LastEditors: ydl
 * @LastEditTime: 2022-12-08 15:40:25
-->
<template>
  <div class="time-rule">
    <div ref="day" class="time-day" :style="{ left: timeDayX + 'px' }">
      <div
      ...
      <div v-for="n in 24" :key="n + 10000" class="time-text">
        <span class="minutebox">
          <div v-for="n in 4" class="minute" />
        </span>
        <span style="">{{ hourText(n - 1) }} </span>
      </div>
    </div>
    <div ref="cursor" class="time-cursor" style="left: 50%">
